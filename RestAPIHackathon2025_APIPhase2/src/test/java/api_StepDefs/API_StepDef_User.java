...
public class API_StepDef_User extends API_BaseSetUp {
	...
	public void admin_sends_https_request_with_endpoint_for(DataTable dataTable) throws FileNotFoundException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, JsonMappingException, JsonProcessingException {
	...
	@Then("user stores the response in a list for further validations")
	public void user_stores_the_response_in_a_list_for_further_validations() {
	    System.out.println("need to do validations");
	}
...
(DataTable dataTable) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, JsonMappingException, JsonProcessingException {
	List<List<String>> rows = dataTable.asLists(String.class);
	   for (List<String> columns : rows) {
		    String conditionTag = columns.get(0);
		    String secondTag = columns.get(1);
