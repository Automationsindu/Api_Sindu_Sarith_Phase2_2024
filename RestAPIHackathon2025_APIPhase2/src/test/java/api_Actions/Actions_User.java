...
public class Actions_User {
	...
	public Response getReqsOfUser(RequestSpecification reqSpec, String conditionTag,String scenarioTag,String IdTag) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, JsonMappingException, JsonProcessingException {
		...
		String finalEndpoint = "";
		 ...
		 endpoint=(String) field.get(null);
		    	   ...
		    	   String jsonString= response.getBody().asPrettyString();
			    	...
			    	//Actions_User userObj= restUtil.getResponseInObject(response,Actions_User.class);
			       //System.out.println("userObj is"+userObj);
			    	ObjectMapper objectMapper = new ObjectMapper();
			    	List<Map<String,Object>> listObjMap=objectMapper.readValue(jsonString, new TypeReference<List<Map<String,Object>>>(){});
		    	   for(Map<String,Object>map:listObjMap) {
		    		   //System.out.println("each map value is "+map);
